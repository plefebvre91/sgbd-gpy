...
\indent Réaliser le modèle conceptuel demande de préciser la description du sujet, mais aussi de faire de choix. Nous verrons ces différents choix avant de présenter les entités et de détailler les opérations autorisées sur chaque entité.
