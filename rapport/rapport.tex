...
\indent D'un point de vue implémentation, il est demandé de réaliser des requêtes classiques de consultation, de mise à jour, d'ajout ou encore de suppression. Par ailleurs, certaines requêtes plus avancées sont requises, elles seront explicités plus tard dans ce document. \\
